 ...
 *
 */
public class PutUtility implements Actions {
	private Instant startTime;
	private Instant endTime;
	private Context apiModel;
	private ApiOutputModel apiOutputModel;
	private String baseUrl;
	final static Logger logger = Logger.getLogger(PutUtility.class);

	public PutUtility(String json) {
	...
	private Builder setUrl(Builder builder, String apiname, String apiVersion) {
		  if (!this.baseUrl.endsWith("/")) { builder.url(this.baseUrl + "/" + apiVersion + "/" +apiname);
		  } else { builder.url(baseUrl + apiVersion + "/" +apiname); }
	...
	/**
	 * This method is responsible for sending the PUT request to the URL/Endpoint 
	 *
	 */
