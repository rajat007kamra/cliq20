...
/**
 * This class s is responsible for GET call executions
 * 
 * @author Surbhi.Singh
 *
 */
public class GetUtility implements Actions {
	private Instant startTime;
	private Instant endTime;
	private Context apiModel;
	private ApiOutputModel apiOutputModel;
	private String baseUrl;
	final static Logger logger = Logger.getLogger(GetUtility.class);

	public GetUtility(String json) {
	...
	/**
	 * This method is responsible for sending the GET request to the URL/Endpoint 
	 *
	 */
	private ApiOutputModel doGet(Context apiModel) {
		try {
			...
			this.apiOutputModel.setResponseBody(apiResponse.body().string());
